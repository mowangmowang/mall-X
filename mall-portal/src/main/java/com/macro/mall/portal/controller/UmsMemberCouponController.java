...
public class UmsMemberCouponController {
    ...
    @Parameter(name = "useStatus", description = "优惠券筛选类型:0->未使用；1->已使用；2->已过期", example = "0")
    ...
    @Parameter(name = "type", description = "使用可用:0->不可用；1->可用", example = "1")
