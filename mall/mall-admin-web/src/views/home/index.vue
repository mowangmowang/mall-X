        ...
        <el-col :xs="24" :sm="12">
          <div class="out-border">
            <div style="padding: 40px">
              <el-row>
                <el-col :xs="12" :sm="6" class="color-danger overview-item-value">100</el-col>
                <el-col :xs="12" :sm="6" class="color-danger overview-item-value">400</el-col>
                <el-col :xs="12" :sm="6" class="color-danger overview-item-value">50</el-col>
                <el-col :xs="12" :sm="6" class="color-danger overview-item-value">500</el-col>
              </el-row>
              <el-row class="font-medium">
                <el-col :xs="12" :sm="6" class="overview-item-title">已下架</el-col>
                <el-col :xs="12" :sm="6" class="overview-item-title">已上架</el-col>
                <el-col :xs="12" :sm="6" class="overview-item-title">库存紧张</el-col>
                <el-col :xs="12" :sm="6" class="overview-item-title">全部商品</el-col>
              </el-row>
            </div>
          </div>
        </el-col>
        <el-col :xs="24" :sm="12">
          <div class="out-border">
            <div style="padding: 40px">
              <el-row>
                <el-col :xs="12" :sm="6" class="color-danger overview-item-value">100</el-col>
                <el-col :xs="12" :sm="6" class="color-danger overview-item-value">200</el-col>
                <el-col :xs="12" :sm="6" class="color-danger overview-item-value">1000</el-col>
                <el-col :xs="12" :sm="6" class="color-danger overview-item-value">5000</el-col>
              </el-row>
              <el-row class="font-medium">
                <el-col :xs="12" :sm="6" class="overview-item-title">今日新增</el-col>
                <el-col :xs="12" :sm="6" class="overview-item-title">昨日新增</el-col>
                <el-col :xs="12" :sm="6" class="overview-item-title">本月新增</el-col>
                <el-col :xs="12" :sm="6" class="overview-item-title">会员总数</el-col>
              </el-row>
            </div>
          </div>
        </el-col>
